...
if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) ) 
{
	...
	function phoe_show_short_desc() {
		...
		<div class="phoeniixx_short_desc" style="display:<?php echo($_COOKIE['phoen_gridcookie']=='phoen_grid')?'none':'block';?>"  > <?php echo "<h3>"; echo(get_the_excerpt());  echo "</h3>"; ?> </div>
		<?php 
